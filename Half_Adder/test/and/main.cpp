...
/*************** Loggers *******************/
  static std::ofstream out_data("andCAD_test_output.txt");
...
/****** APPLICATION GENERATOR *******************/
/********************************************/
string input_data_one = "andCAD_input_test_1.txt";
...
string input_data_two = "andCAD_input_test_2.txt";
...
cadmium::dynamic::modeling::Models submodels_TOP = {generator_one, generator_two, andCAD1};
cadmium::dynamic::modeling::EICs eics_TOP = {};
cadmium::dynamic::modeling::EOCs eocs_TOP = {
  cadmium::dynamic::translate::make_EOC<andCAD_defs::outa,outp>("andCAD1")
};
cadmium::dynamic::modeling::ICs ics_TOP = {
  cadmium::dynamic::translate::make_IC<iestream_input_defs<Message_t>::out,andCAD_defs::in1>("generator_one","andCAD1"), 
  cadmium::dynamic::translate::make_IC<iestream_input_defs<Message_t>::out,andCAD_defs::in2>("generator_two","andCAD1")
};
